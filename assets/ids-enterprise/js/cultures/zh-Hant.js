...
Soho.Locale.addCulture('zh-Hant', {
  ...
  calendars: [{
    ...
    dateFormat: {
      ...
      datetimeMillis: 'yyyy/M/d HH:mm.SSS',
      dateTimestamp: 'yyyy/M/d HH:mm',
  ...
  messages: {
    ...
    Black: { id: 'Black', value: '黑色', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: '區塊引述', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: '藍色', comment: 'Refers to an blue color band' },
    ...
    CharactersMax: { id: 'CharactersMax', value: '已超過字元計數 {0}', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    Collapse: { id: 'Collapse', value: '摺疊', comment: 'Collapse / close a tree/submenu' },
    CollapseAppTray: { id: 'CollapseAppTray', value: '摺疊 App 托盤', comment: 'Collapse app tray tooltip' },
    Color: { id: 'Color', value: '色彩', comment: 'Color' },
    ColorPickerSelection: { id: 'ColorPickerSelection', value: '挑選自訂色彩', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: '按一下以開啟色彩選擇器', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: '複製到剪貼簿', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: '觸發日期選擇器', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: '早於或直至', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExpandCollapse: { id: 'ExpandCollapse', value: '展開/摺疊', comment: 'Text to toggle a button in a container.' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: '超超小', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: '使用 AI 生成', comment: 'Button for Generative AI' },
    German: { id: 'German', value: '德文', comment: 'Language name for german' },
    Go: { id: 'Go', value: '開始', comment: 'Go, perform a movement, start a search, move to the next thing in a workflow.' },
    ...
    Green: { id: 'Green', value: '綠色', comment: 'Refers to an green color band' },
    ...
    Image: { id: 'Image', value: '圖像', comment: 'Image of something' },
    ...
    Loading: { id: 'Loading', value: '載入', comment: 'Text below spinning indicator to indicate loading' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: '觸發查閱', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    Mobile: { id: 'Mobile', value: '行動電話', comment: 'Indicates a mobile device (phone tablet ect)' },
    ...
    Neutral: { id: 'Neutral', value: '中性', comment: 'This corresponds to a neutral color' },
    ...
    Next: { id: 'Next', value: '下一步', comment: 'Generic next for a tooltip, see Next Record and Next Page for more specific' },
    ...
    Orange: { id: 'Orange', value: '橙色', comment: 'Refers to an orange color band' },
    ...
    Purple: { id: 'Purple', value: '紫色', comment: 'Refers to an purple color band' },
    ...
    Red: { id: 'Red', value: '紅色', comment: 'This corresponds to a red color' },
    ...
    ShowLess: { id: 'ShowLess', value: '顯示較少', comment: 'Show less form content' },
    ...
    SplitterCollapseButton: { id: 'SplitterCollapseButton', value: '摺疊分隔器', comment: 'Action to move the position of splitter either to left or right' },
    ...
    Teal: { id: 'Teal', value: '藍綠色', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: '拖放至此處或<span class=\'hyperlink\'>上載檔案</span>以上載', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    Theme: { id: 'Theme', value: '主題', comment: 'Refers to an application theme' },
    ...
    TreeCollapse: { id: 'TreeCollapse', value: '摺疊樹狀目錄', comment: 'Tree collapse tooltip' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: '拖放至此處以上載檔案' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>錯誤</em>上載的檔案數目不得大於檔案數目上限 ({maxFiles})。' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>錯誤</em> 超出允許的檔案上限' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>錯誤</em> 超出檔案大小限制' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>錯誤</em> 不允許的檔案類型' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>錯誤</em> Url 找不到' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>錯誤</em> 要求標題必須是有效的 JSON 字串' },
    UploadLink: { id: 'UploadLink', value: '上載檔案' },
    UploadCancel: { id: 'UploadCancel', value: '取消上載此檔案' },
    UploadCancelAll: { id: 'UploadCancelAll', value: '全部取消' },
    UploadDismissError: { id: 'UploadDismissError', value: '關閉此錯誤' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} 已上載 {loaded}，共 {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: '移除此檔案' },
    UploadStart: { id: 'UploadStart', value: '開始上載此檔案' },
    ...
    White: { id: 'White', value: '白色', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: '黃色', comment: 'This corresponds to a yellow color' },
