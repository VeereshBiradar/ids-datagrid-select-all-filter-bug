...
Soho.Locale.addCulture('it-IT', {
  ...
  messages: {
    ...
    AddComments: { id: 'AddComments', value: 'Add commenti', comment: 'Add comments to a form of data' },
    ...
    And: { id: 'And', value: 'e', comment: 'Text used in calendar' },
    ...
    Arabic: { id: 'Arabic', value: 'Arabo', comment: 'Language name for Arabic (general)' },
    Attach: { id: 'Attach', value: 'Allega', comment: 'Attach' },
    Available: { id: 'Available', value: 'Disponibili', comment: 'Button tooltip used in a list of movable items' },
    ...
    BarChart: { id: 'BarChart', value: 'Grafico a barre', comment: 'A chart type' },
    ...
    Black: { id: 'Black', value: 'Nero', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Citazione', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Blu', comment: 'Refers to an blue color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Lingua del browser', comment: 'Language in the current web bowser' },
    Bulgarian: { id: 'Bulgarian', value: 'Bulgaro', comment: 'Language name for Bulgarian (Bulgaria)' },
    ...
    Caution: { id: 'Caution', value: 'Attenzione', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Il numero di caratteri di {0} è stato superato', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    Chinese: { id: 'Chinese', value: 'Cinese', comment: 'Chinese language in general form' },
    ChooseFont: { id: 'ChooseFont', value: 'Scegli stile carattere', comment: 'Choose a font style' },
    Classic: { id: 'Classic', value: 'Classico', comment: 'This is the name of the older styling of all components (theme name)' },
    ClassicDarkTheme: { id: 'ClassicDarkTheme', value: 'Classico scuro', comment: 'The name of an application Theme' },
    ClassicHighContrastTheme: { id: 'ClassicHighContrastTheme', value: 'Classico contrasto elevato', comment: 'The name of an application Theme' },
    ClassicLightTheme: { id: 'ClassicLightTheme', value: 'Classico chiaro', comment: 'The name of an application Theme' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Scegliere un colore personalizzato', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Fare clic per aprire Selezione colori', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Copia negli Appunti', comment: 'Copy text' },
    Croatian: { id: 'Croatian', value: 'Croato', comment: 'Croatian (Croatia) language' },
    ...
    Czech: { id: 'Czech', value: 'Ceco', comment: 'Language name for Czech Language' },
    Danish: { id: 'Danish', value: 'Danese', comment: 'Language name for Danish' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Trigger selezione data', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    DayAbbreviatedThu: { id: 'DayAbbreviatedThu', value: 'Gio', comment: 'Day of the week in abbreviated form' },
    ...
    DayNarrowThu: { id: 'DayNarrowThu', value: 'G', comment: 'Day of the week in shortest form' },
    ...
    DayWideFri: { id: 'DayWideFri', value: 'Venerdì', comment: 'Day of the week in long form' },
    DayWideMon: { id: 'DayWideMon', value: 'Lunedì', comment: 'Day of the week in long form' },
    DayWideSat: { id: 'DayWideSat', value: 'Sabato', comment: 'Day of the week in long form' },
    DayWideSun: { id: 'DayWideSun', value: 'Domenica', comment: 'Day of the week in long form' },
    DayWideThu: { id: 'DayWideThu', value: 'Giovedì', comment: 'Day of the week in long form' },
    DayWideTue: { id: 'DayWideTue', value: 'Martedì', comment: 'Day of the week in long form' },
    DayWideWed: { id: 'DayWideWed', value: 'Mercoledì', comment: 'Day of the week in long form' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Fare clic per aprire l\'elenco a discesa', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    Duplicate: { id: 'Duplicate', value: 'Duplicato', comment: 'Duplicate tooltip' },
    Duration: { id: 'Duration', value: 'Durata', comment: 'The length of a time span between two times' },
    Dutch: { id: 'Dutch', value: 'Olandese', comment: 'Language name for Dutch (Netherlands)' },
    EarlyOrEquals: { id: 'EarlyOrEquals', value: 'Precedente o uguale a', comment: 'Earlier than or equals in icons for filtering' },
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Prima di o fino a', comment: 'Earlier than or equals in icons for filtering' },
    EarlyThan: { id: 'EarlyThan', value: 'Precedente a', comment: 'Early Than in icons for filtering' },
    Edit: { id: 'Edit', value: 'Modifica', comment: 'Edit tooltip' },
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Selezionati o Non selezionati', comment: 'Either selected or not selected in icons for filtering' },
    ...
    English: { id: 'English', value: 'Inglese (Stati Uniti)', comment: 'Language name for English' },
    ...
    Estonian: { id: 'Estonian', value: 'Estone', comment: 'Language name for Estonian' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Espandi barra applicazioni', comment: 'Expand app tray tooltip' },
    ...
    ExportToCsv: { id: 'ExportToCsv', value: 'Esporta in CSV', comment: 'Export to CSV menu option in datagrid' },
    ExportToExcel: { id: 'ExportToExcel', value: 'Esporta in Excel', comment: 'Export to Excel menu option in datagrid' },
    ExtraSmall: { id: 'ExtraSmall', value: 'Molto piccola', comment: 'A smaller font size and compressed mode for datagrid rows.' },
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Piccolissima', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    Finnish: { id: 'Finnish', value: 'Finlandese', comment: 'Language name for Finnish' },
    ...
    French: { id: 'French', value: 'Francese', comment: 'Language name for French' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Genera con AI', comment: 'Button for Generative AI' },
    German: { id: 'German', value: 'Tedesco', comment: 'Language name for german' },
    ...
    GreaterOrEquals: { id: 'GreaterOrEquals', value: 'Maggiore di o uguale a', comment: 'Greater Than Or Equals in icons for filtering' },
    ...
    Hebrew: { id: 'Hebrew', value: 'Ebraico', comment: 'Language name for Hebrew' },
    ...
    Highlight: { id: 'Highlight', value: 'Evidenzia', comment: 'Used to highlight (select) a chart item' },
    ...
    Hungarian: { id: 'Hungarian', value: 'Ungherese', comment: 'Language name for Hungarian' },
    ...
    Indonesian: { id: 'Indonesian', value: 'Indonesiano', comment: 'Language name for Indonesian' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Inserisci collegamento ipertestuale', comment: 'Insert a hyperlink (synonymous with link or anchor tag) into an editor. Please recheck this as it was renamed from anchor.' },
    ...
    InvalidDateTime: { id: 'InvalidDateTime', value: 'Data/Ora non valida', comment: 'validation message for wrong date and time format' },
    ...
    Japanese: { id: 'Japanese', value: 'Giapponese', comment: 'Language name for Japanese' },
    ...
    LaterOrEquals: { id: 'LaterOrEquals', value: 'Successivo o uguale a', comment: 'Later than or equals in icons for filtering' },
    LaterOrOn: { id: 'LaterOrOn', value: 'Dopo il oppure il', comment: 'Later Than Or Equals in icons for filtering' },
    LaterThan: { id: 'LaterThan', value: 'Successivo a', comment: 'Later than in icons for filtering' },
    Latvian: { id: 'Latvian', value: 'Lettone', comment: 'Language name for Latvian' },
    ...
    LessOrEquals: { id: 'LessOrEquals', value: 'Minore di o uguale a', comment: 'Less than or equals in icons for filtering' },
    ...
    LineChart: { id: 'LineChart', value: 'Grafico a linee', comment: 'A chart type' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Trigger ricerca', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    Lowest: { id: 'Lowest', value: 'Valore minimo', comment: 'Lowest - as in lowest value' },
    Mail: { id: 'Mail', value: 'Posta', comment: 'Mail tooltip' },
    Malay: { id: 'Malay', value: 'Malese', comment: 'Language name for Malay' },
    MapPin: { id: 'MapPin', value: 'Contrassegna', comment: 'Map Pin tooltip' },
    ...
    MenuGroup: { id: 'MenuGroup', value: 'Gruppo di menu contenente voci di {0}', comment: 'Describes the number of menu items contained inside the group (accessibility when items are focused)' },
    ...
    Modes: { id: 'Modes', value: 'Modalità', comment: 'Indicates a selection of Modes of a theme (like dark or light mode)' },
    ...
    MonthAbbreviatedJan: { id: 'MonthAbbreviatedJan', value: 'Gen', comment: 'Month in abbreviated form' },
    MonthAbbreviatedJuly: { id: 'MonthAbbreviatedJuly', value: 'Lug', comment: 'Month in abbreviated form' },
    MonthAbbreviatedJune: { id: 'MonthAbbreviatedJune', value: 'Giu', comment: 'Month in abbreviated form' },
    ...
    MonthAbbreviatedLowerCaseJan: { id: 'MonthAbbreviatedJan', value: 'Gen', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseJuly: { id: 'MonthAbbreviatedJuly', value: 'Lug', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseJune: { id: 'MonthAbbreviatedJune', value: 'Giu', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthAbbreviatedLowerCaseMay: { id: 'MonthAbbreviatedMay', value: 'Mag', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthAbbreviatedLowerCaseOct: { id: 'MonthAbbreviatedOct', value: 'Ott', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthAbbreviatedMay: { id: 'MonthAbbreviatedMay', value: 'Mag', comment: 'Month in abbreviated form' },
    MonthAbbreviatedNov: { id: 'MonthAbbreviatedNov', value: 'Nov', comment: 'Month in abbreviated form' },
    MonthAbbreviatedOct: { id: 'MonthAbbreviatedOct', value: 'Ott', comment: 'Month in abbreviated form' },
    MonthAbbreviatedSep: { id: 'MonthAbbreviatedSep', value: 'Set', comment: 'Month in abbreviated form' },
    MonthWideApr: { id: 'MonthWideApr', value: 'Aprile', comment: 'Month in wide form' },
    MonthWideAug: { id: 'MonthWideAug', value: 'Agosto', comment: 'Month in wide form' },
    MonthWideDec: { id: 'MonthWideDec', value: 'Dicembre', comment: 'Month in wide form' },
    MonthWideFeb: { id: 'MonthWideFeb', value: 'Febbraio', comment: 'Month in wide form' },
    MonthWideJan: { id: 'MonthWideJan', value: 'Gennaio', comment: 'Month in wide form' },
    MonthWideJuly: { id: 'MonthWideJuly', value: 'Luglio', comment: 'Month in wide form' },
    MonthWideJune: { id: 'MonthWideJune', value: 'Giugno', comment: 'Month in wide form' },
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'aprile', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'agosto', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'dicembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseFeb: { id: 'MonthWideFeb', value: 'febbraio', comment: 'Month in wide form - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'gennaio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'luglio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'giugno', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'marzo', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'maggio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'novembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'ottobre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'settembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideMar: { id: 'MonthWideMar', value: 'Marzo', comment: 'Month in wide form' },
    MonthWideMay: { id: 'MonthWideMay', value: 'Maggio', comment: 'Month in wide form' },
    MonthWideNov: { id: 'MonthWideNov', value: 'Novembre', comment: 'Month in wide form' },
    MonthWideOct: { id: 'MonthWideOct', value: 'Ottobre', comment: 'Month in wide form' },
    MonthWideSep: { id: 'MonthWideSep', value: 'Settembre', comment: 'Month in wide form' },
    ...
    Neutral: { id: 'Neutral', value: 'Neutro', comment: 'This corresponds to a neutral color' },
    New: { id: 'New', value: 'Nuovo', comment: 'Any generic new thing' },
    NewDarkTheme: { id: 'NewDarkTheme', value: 'Nuovo scuro', comment: 'The name of an application Theme' },
    ...
    NewHighContrastTheme: { id: 'NewHighContrastTheme', value: 'Nuovo contrasto elevato', comment: 'The name of an application Theme' },
    NewItem: { id: 'NewItem', value: 'Nuovo elemento', comment: 'New item in listbuilder' },
    NewLightTheme: { id: 'NewLightTheme', value: 'Nuovo chiaro', comment: 'The name of an application Theme' },
    NewRow: { id: 'New', value: 'Nuovo', comment: 'Indicates a new row added in the datagrid' },
    NewWindow: { id: 'NewWindow', value: 'Nuova finestra', comment: 'Contents open in a new browser window.' },
    Next: { id: 'Next', value: 'Avanti', comment: 'Generic next for a tooltip, see Next Record and Next Page for more specific' },
    NextMonth: { id: 'NextMonth', value: 'Mese successivo', comment: 'The label for the button that moves calendar to next/prev' },
    NextPage: { id: 'NextPage', value: 'Pagina successiva', comment: 'Move to next item on Pager component' },
    NextRecord: { id: 'NextRecord', value: 'Record successivo', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    NextWeek: { id: 'NextWeek', value: 'Settimana successiva', comment: 'The label for the button that moves calendar to next/prev' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Non è stato trovato alcun risultato', comment: 'Search Results Text' },
    NoRecordSelected: { id: 'NoRecordSelected', value: '0 record selezionati', comment: 'Text showing no records selected' },
    ...
    Norwegian: { id: 'Norwegian', value: 'Norvegese', comment: 'Language name for Norwegian' },
    ...
    Orange: { id: 'Orange', value: 'Arancione', comment: 'Refers to an orange color band' },
    ...
    Polish: { id: 'Polish', value: 'Polacco', comment: 'Language name for Polish' },
    Portuguese: { id: 'Portuguese', value: 'Portoghese', comment: 'Language name for Portuguese' },
    ...
    Previous: { id: 'Previous', value: 'Precedente', comment: 'Generic previous for a tooltip, see next record and next page for more specific' },
    PreviousMonth: { id: 'PreviousMonth', value: 'Mese precedente', comment: 'the label for the button that moves calendar to next/prev' },
    PreviousPage: { id: 'PreviousPage', value: 'Pagina precedente', comment: 'Move to next item on Pager component' },
    PreviousRecord: { id: 'PreviousRecord', value: 'Record precedente', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    PreviousWeek: { id: 'PreviousWeek', value: 'Settimana precedente', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    Purple: { id: 'Purple', value: 'Viola', comment: 'Refers to an purple color band' },
    Range: { id: 'Range', value: 'Intervallo', comment: 'Range for tooltip' },
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} record per pagina', comment: 'Shows an actual number of pages in the pager' },
    ...
    RecordSelected: { id: 'RecordSelected', value: '{0} record selezionati', comment: 'Text showing current total of record selected' },
    RecordsSelected: { id: 'RecordsSelected', value: '{0} record selezionati', comment: 'Text showing current total of records selected' },
    Red: { id: 'Red', value: 'Rosso', comment: 'This corresponds to a red color' },
    ...
    Romanian: { id: 'Romanian', value: 'Rumeno', comment: 'Language name for Romanian' },
    ...
    Selected: { id: 'Selected', value: 'Selezionati', comment: 'Text describing a selected object' },
    SelectedOptions: { id: 'SelectedOptions', value: 'Opzioni selezionate', comment: 'shown on a list of selected dropdown options (generic)' },
    Selection: { id: 'Selection', value: 'Selezione', comment: 'Text describing current selections in a field' },
    Send: { id: 'Send', value: 'Invia', comment: 'Send tooltip' },
    SetTime: { id: 'SetTime', value: 'Imposta ora', comment: 'Button that sets time in a field' },
    ...
    ShowLess: { id: 'ShowLess', value: 'Mostra meno', comment: 'Show less form content' },
    ShowMore: { id: 'ShowMore', value: 'Mostra altro', comment: 'Show more form content' },
    ...
    Slovak: { id: 'Slovak', value: 'Slovacco', comment: 'Language name for Slovak (Slovakia)' },
    Slovenian: { id: 'Slovenian', value: 'Sloveno', comment: 'Language name for Slovenian' },
    Small: { id: 'Small', value: 'Piccola', comment: 'A more small grid setting for rows and sizes.' },
    ...
    Spanish: { id: 'Spanish', value: 'Spagnolo', comment: 'Language name for Spanish' },
    ...
    Status: { id: 'Status', value: 'Stato', comment: 'Status thats submitted fx in progress, approved' },
    StepsCompleted: { id: 'StepsCompleted', value: '{0} di {1} passaggi completati', comment: 'steps of a wizard/chart' },
    ...
    Success: { id: 'Success', value: 'Operazione riuscita', comment: 'For a success message on screen' },
    ...
    Swedish: { id: 'Swedish', value: 'Svedese', comment: 'Language name for Swedish' },
    Tabs: { id: 'Tabs', value: 'Schede...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    Tack: { id: 'Tack', value: 'Contrassegna', comment: 'Pin an object' },
    ...
    Teal: { id: 'Teal', value: 'Turchese', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Selezionare e trascinare qui o <span class=\'hyperlink\'>caricare i file</span> da caricare', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Selezionare e trascinare qui o {browseLink}', comment: 'Updated recently' },
    Thai: { id: 'Thai', value: 'Thailandese', comment: 'Language name for Thai' },
    ...
    ToggleBold: { id: 'ToggleBold', value: 'Attiva/Disattiva testo grassetto', comment: 'turn on and off bold in text editor (like word) please check this for thai see https://github.com/infor-design/enterprise/issues/4738' },
    ...
    ToggleUnderline: { id: 'ToggleUnderline', value: 'Attiva/Disattiva testo sottolineato', comment: 'turn on and off Underline in text editor (like word) please check this for thai https://github.com/infor-design/enterprise/issues/4738' },
    ...
    Ukrainian: { id: 'Ukrainian', value: 'Ucraino', comment: 'Language name for Ukrainian' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Selezionare e trascinare qui per caricare i file' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Errore</em> Non è possibile aggiornare un numero di file superiore al massimo consentito ({maxFiles}).' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Errore</em> È stato superato il numero massimo di file consentiti' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Errore</em> È stata superata la dimensione massima file' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Errore</em> Tipo di file non consentito' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Errore</em> Url non trovato' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Errore</em> Le intestazioni della richiesta devono essere una stringa JSON valida' },
    UploadLink: { id: 'UploadLink', value: 'caricare i file' },
    UploadCancel: { id: 'UploadCancel', value: 'Annulla caricamento file corrente' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Annulla tutto' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Elimina questo errore' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} caricati {loaded} su {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Rimuovi questo file' },
    UploadStart: { id: 'UploadStart', value: 'Inizia caricamento file corrente' },
    ...
    Versions: { id: 'Versions', value: 'Versioni', comment: 'A selection of versions of the styles' },
    ...
    Warning: { id: 'Warning', value: 'Avviso', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Bianco', comment: 'Refers to an white color band' },
    Week: { id: 'Week', value: 'Settimana', comment: 'Shows a view of the current weeks events' },
    WeekNumber: { id: 'WeekNumber', value: 'S#', comment: 'Week view number header on the datepicker' },
    Year: { id: 'Year', value: 'Anno', comment: 'As in a date year' },
    Yellow: { id: 'Yellow', value: 'Giallo', comment: 'This corresponds to a yellow color' },
