...
Soho.Locale.addCulture('cs-CZ', {
  ...
  messages: {
    ...
    Afrikaans: { id: 'Afrikaans', value: 'Afrikánština', comment: 'Language name for Afrikaans (South Africa)' },
    Alabaster: { id: 'Alabaster', value: 'Alabastrová', comment: 'Color in our color palette' },
    ...
    Arabic: { id: 'Arabic', value: 'Arabština', comment: 'Language name for Arabic (general)' },
    ...
    BarChart: { id: 'BarChart', value: 'Pruhový graf', comment: 'A chart type' },
    ...
    Black: { id: 'Black', value: 'Černá', comment: 'Refers to an black color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Jazyk prohlížeče', comment: 'Language in the current web bowser' },
    Bulgarian: { id: 'Bulgarian', value: 'Bulharština', comment: 'Language name for Bulgarian (Bulgaria)' },
    ...
    Caution: { id: 'Caution', value: 'Pozor', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Byl překročen počet znaků {0}', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ChooseFont: { id: 'ChooseFont', value: 'Vybrat styl písma', comment: 'Choose a font style' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Vybrat vlastní barvu', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Kliknutím otevřete výběr barvy', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Kopírovat do schránky', comment: 'Copy text' },
    Croatian: { id: 'Croatian', value: 'Chorvatština', comment: 'Croatian (Croatia) language' },
    ...
    Danish: { id: 'Danish', value: 'Dánština', comment: 'Language name for Danish' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Spouštěč výběru data', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    Device: { id: 'Device', value: 'Zařízení', comment: 'Name of the device' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Kliknutím otevřete rozbalovací seznam', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    ...
    Dutch: { id: 'Dutch', value: 'Nizozemština', comment: 'Language name for Dutch (Netherlands)' },
    EarlyOrEquals: { id: 'EarlyOrEquals', value: 'Dřívější než nebo rovno', comment: 'Earlier than or equals in icons for filtering' },
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Dřívější než nebo do', comment: 'Earlier than or equals in icons for filtering' },
    EarlyThan: { id: 'EarlyThan', value: 'Dřívější než', comment: 'Early Than in icons for filtering' },
    Edit: { id: 'Edit', value: 'Upravit', comment: 'Edit tooltip' },
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Vybrané nebo nevybrané', comment: 'Either selected or not selected in icons for filtering' },
    ...
    English: { id: 'English', value: 'Angličtina (Spojené státy)', comment: 'Language name for English' },
    ...
    Estonian: { id: 'Estonian', value: 'Estonština', comment: 'Language name for Estonian' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Rozbalit panel aplikace', comment: 'Expand app tray tooltip' },
    ...
    ExportToCsv: { id: 'ExportToCsv', value: 'Export do CSV', comment: 'Export to CSV menu option in datagrid' },
    ...
    FileUpload: { id: 'FileUpload', value: 'Nahrání souboru. Chcete-li vyhledat soubor, stiskněte klávesu Enter', comment: 'Screen Reader instructions' },
    Filter: { id: 'Filter', value: 'Filtr', comment: 'Filter tooltip' },
    Finnish: { id: 'Finnish', value: 'Finština', comment: 'Language name for Finnish' },
    ...
    French: { id: 'French', value: 'Francouzština', comment: 'Language name for French' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Generovat pomocí AI', comment: 'Button for Generative AI' },
    German: { id: 'German', value: 'Němčina', comment: 'Language name for german' },
    ...
    GroupsPerPage: { id: 'GroupsPerPage', value: 'Počet skupin na stránku: {0}', comment: 'Dropdown allows the user to select how many visible Groups the {} placeholder shows value. NOTE: Please change japanese to ページあたりのグループ数 for next time' },
    ...
    Hebrew: { id: 'Hebrew', value: 'Hebrejština', comment: 'Language name for Hebrew' },
    ...
    Hindi: { id: 'Hindi', value: 'Hindština', comment: 'Language name for Hindi' },
    ...
    Hungarian: { id: 'Hungarian', value: 'Maďarština', comment: 'Language name for Hungarian' },
    ...
    Indonesian: { id: 'Indonesian', value: 'Indonéština', comment: 'Language name for Indonesian' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Vložit hypertextový odkaz', comment: 'Insert a hyperlink (synonymous with link or anchor tag) into an editor. Please recheck this as it was renamed from anchor.' },
    ...
    Japanese: { id: 'Japanese', value: 'Japonština', comment: 'Language name for Japanese' },
    ...
    Korean: { id: 'Korean', value: 'Korejština', comment: 'Language name for Korean' },
    ...
    LaterOrEquals: { id: 'LaterOrEquals', value: 'Pozdější než nebo rovno', comment: 'Later than or equals in icons for filtering' },
    LaterOrOn: { id: 'LaterOrOn', value: 'Pozdější než nebo během', comment: 'Later Than Or Equals in icons for filtering' },
    LaterThan: { id: 'LaterThan', value: 'Pozdější než', comment: 'Later than in icons for filtering' },
    Latvian: { id: 'Latvian', value: 'Lotyšština', comment: 'Language name for Latvian' },
    ...
    LineChart: { id: 'LineChart', value: 'Spojnicový graf', comment: 'A chart type' },
    Lithuanian: { id: 'Lithuanian', value: 'Litevština', comment: 'Language name for Lithuanian' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Spouštěč vyhledávání', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    Lowest: { id: 'Lowest', value: 'Nejnižší', comment: 'Lowest - as in lowest value' },
    Mail: { id: 'Mail', value: 'E-mail', comment: 'Mail tooltip' },
    Malay: { id: 'Malay', value: 'Malajština', comment: 'Language name for Malay' },
    ...
    MenuGroup: { id: 'MenuGroup', value: 'Skupina nabídek obsahuje položky ({0})', comment: 'Describes the number of menu items contained inside the group (accessibility when items are focused)' },
    ...
    MonthAbbreviatedLowerCaseApr: { id: 'MonthAbbreviatedApr', value: 'dub', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthAbbreviatedLowerCaseFeb: { id: 'MonthAbbreviatedFeb', value: 'úno', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseJan: { id: 'MonthAbbreviatedJan', value: 'led', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseJuly: { id: 'MonthAbbreviatedJuly', value: 'čvc', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseJune: { id: 'MonthAbbreviatedJune', value: 'čer', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseLowerCaseAug: { id: 'MonthAbbreviatedAug', value: 'srp', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseMar: { id: 'MonthAbbreviatedMar', value: 'bře', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseMay: { id: 'MonthAbbreviatedMay', value: 'kvě', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthAbbreviatedLowerCaseOct: { id: 'MonthAbbreviatedOct', value: 'říj', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    MonthAbbreviatedLowerCaseSep: { id: 'MonthAbbreviatedSep', value: 'zář', comment: 'Month in abbreviated form lower case - in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'duben', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'srpen', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'prosinec', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseFeb: { id: 'MonthWideFeb', value: 'únor', comment: 'Month in wide form - in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'leden', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'červenec', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'červen', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'březen', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'květen', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'říjen', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'září', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Neutrální', comment: 'This corresponds to a neutral color' },
    New: { id: 'New', value: 'Nový', comment: 'Any generic new thing' },
    ...
    NewRow: { id: 'New', value: 'Nový', comment: 'Indicates a new row added in the datagrid' },
    NewWindow: { id: 'NewWindow', value: 'Nové okno', comment: 'Contents open in a new browser window.' },
    Next: { id: 'Next', value: 'Následující', comment: 'Generic next for a tooltip, see Next Record and Next Page for more specific' },
    NextMonth: { id: 'NextMonth', value: 'Příští měsíc', comment: 'The label for the button that moves calendar to next/prev' },
    NextPage: { id: 'NextPage', value: 'Následující stránka', comment: 'Move to next item on Pager component' },
    NextRecord: { id: 'NextRecord', value: 'Následující záznam', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    NextWeek: { id: 'NextWeek', value: 'Příští týden', comment: 'The label for the button that moves calendar to next/prev' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Nebyly nalezeny žádné výsledky', comment: 'Search Results Text' },
    NoRecordSelected: { id: 'NoRecordSelected', value: 'Vybráno 0 záznamů', comment: 'Text showing no records selected' },
    ...
    Norwegian: { id: 'Norwegian', value: 'Norština', comment: 'Language name for Norwegian' },
    ...
    PasswordValidation: { id: 'PasswordValidation', value: '<strong>Pravidla pro hesla:</strong><br>Délka alespoň 10 znaků<br>Alespoň jedno velké písmeno<br>Alespoň jedno malé písmeno<br>Alespoň jeden speciální znak<br>Nesmí obsahovat vaše uživatelské jméno<br>Nesmí se shodovat s dříve použitým heslem<br>', comment: 'Password validation requirements' },
    ...
    Polish: { id: 'Polish', value: 'Polština', comment: 'Language name for Polish' },
    Portuguese: { id: 'Portuguese', value: 'Portugalština', comment: 'Language name for Portuguese' },
    ...
    Previous: { id: 'Previous', value: 'Předchozí', comment: 'Generic previous for a tooltip, see next record and next page for more specific' },
    PreviousMonth: { id: 'PreviousMonth', value: 'Minulý měsíc', comment: 'the label for the button that moves calendar to next/prev' },
    PreviousPage: { id: 'PreviousPage', value: 'Předchozí stránka', comment: 'Move to next item on Pager component' },
    PreviousRecord: { id: 'PreviousRecord', value: 'Předchozí záznam', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    PreviousWeek: { id: 'PreviousWeek', value: 'Předchozí týden', comment: 'the label for the button that moves calendar to next/prev' },
    ...
    RecordSelected: { id: 'RecordSelected', value: 'Vybrán {0} záznam', comment: 'Text showing current total of record selected' },
    RecordsSelected: { id: 'RecordsSelected', value: 'Vybrány záznamy ({0})', comment: 'Text showing current total of records selected' },
    ...
    Romanian: { id: 'Romanian', value: 'Rumunština', comment: 'Language name for Romanian' },
    ...
    SelectedOptions: { id: 'SelectedOptions', value: 'Vybrané možnosti', comment: 'shown on a list of selected dropdown options (generic)' },
    Selection: { id: 'Selection', value: 'Výběr', comment: 'Text describing current selections in a field' },
    Send: { id: 'Send', value: 'Odeslat', comment: 'Send tooltip' },
    SetTime: { id: 'SetTime', value: 'Nastavit čas', comment: 'Button that sets time in a field' },
    ...
    Slovak: { id: 'Slovak', value: 'Slovenština', comment: 'Language name for Slovak (Slovakia)' },
    Slovenian: { id: 'Slovenian', value: 'Slovinština', comment: 'Language name for Slovenian' },
    ...
    Spanish: { id: 'Spanish', value: 'Španělština', comment: 'Language name for Spanish' },
    ...
    StrikeThrough: { id: 'StrikeThrough', value: 'Přeškrtnutí', comment: 'Edit text to have a strike through it in an editor' },
    ...
    Success: { id: 'Success', value: 'Úspěšné', comment: 'For a success message on screen' },
    ...
    Swedish: { id: 'Swedish', value: 'Švédština', comment: 'Language name for Swedish' },
    ...
    Tagalog: { id: 'Tagalog', value: 'Tagalština', comment: 'Language name for Tagalog (Philippines)' },
    ...
    Teal: { id: 'Teal', value: 'Tyrkysová', comment: 'Refers to an teal color band' },
    ...
    TextDropArea: { id: 'DropArea', value: 'Nahrání souborů jejich přetažením', comment: 'Text for drop area for advanced fileupload' },
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Soubory nahrajete přetažením nebo <span class=\'hyperlink\'>nahráním</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Soubory přetáhněte sem nebo {browseLink}', comment: 'Updated recently' },
    Thai: { id: 'Thai', value: 'Thajština', comment: 'Language name for Thai' },
    ...
    Ukrainian: { id: 'Ukrainian', value: 'Ukrajinština', comment: 'Language name for Ukrainian' },
    ...
    UpComingTimeOff: { id: 'UpComingTimeOff', value: 'Nadcházející volno', comment: 'As in time off work' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Soubory nahrajete přetažením sem' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Nelze nahrát větší než maximální počet souborů ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Překročen limit počtu souborů' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Chyba</em> Překročen limit velikosti souboru' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Chyba</em> Nepovolený typ souboru' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Adresa URL nenalezena' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Záhlaví požadavku musí být platný řetězec JSON' },
    UploadLink: { id: 'UploadLink', value: 'nahrát soubory' },
    UploadCancel: { id: 'UploadCancel', value: 'Zrušit odesílání tohoto souboru' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Zrušit vše' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Zrušit tuto chybu' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: 'Soubor {file-name} nahrán, {loaded} z {size} ({percent} %)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Odebrat tento soubor' },
    UploadStart: { id: 'UploadStart', value: 'Začít s nahráváním tohoto souboru' },
    ...
    Vietnamese: { id: 'Vietnamese', value: 'Vietnamština', comment: 'Language name for Vietnamese' },
    ...
    Warning: { id: 'Warning', value: 'Varování', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Bílá', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Žlutá', comment: 'This corresponds to a yellow color' },
