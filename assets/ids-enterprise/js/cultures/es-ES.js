...
Soho.Locale.addCulture('es-ES', {
  ...
  messages: {
    ...
    AdministrativeLeave: { id: 'AdministrativeLeave', value: 'Vacación administrativa', comment: 'As in vacation time from work' },
    ...
    And: { id: 'And', value: 'y', comment: 'Text used in calendar' },
    ...
    Black: { id: 'Black', value: 'Negro', comment: 'Refers to an black color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Idioma del explorador', comment: 'Language in the current web bowser' },
    ...
    Caution: { id: 'Caution', value: 'Precaución', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'El número máximo de caracteres ({0}) se ha excedido', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Elegir un color personalizado', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Haga clic en Abrir selector de colores', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Copiar al portapapeles', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Activador del selector de fecha', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Anterior a o hasta', comment: 'Earlier than or equals in icons for filtering' },
    ...
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Lo seleccionado y no seleccionado', comment: 'Either selected or not selected in icons for filtering' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Expandir bandeja de aplicación', comment: 'Expand app tray tooltip' },
    ...
    ExtraSmall: { id: 'ExtraSmall', value: 'Extra pequeña', comment: 'A smaller font size and compressed mode for datagrid rows.' },
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extra extra pequeña', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Generar con AI', comment: 'Button for Generative AI' },
    ...
    Locale: { id: 'Locale', value: 'Config. regional', comment: 'A place or locality for example en-US, it-It' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Activador de búsqueda', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'diciembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'enero', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'julio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'junio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'mayo', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'noviembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'octubre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'septiembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Ningún resultado', comment: 'Search Results Text' },
    ...
    None: { id: 'None', value: 'Ninguno(a)', comment: 'None to pick clear color' },
    ...
    Orange: { id: 'Orange', value: 'Naranja', comment: 'Refers to an orange color band' },
    ...
    PasswordValidation: { id: 'PasswordValidation', value: '<strong>La contraseña debe:</strong><br>Tener un mínimo de 10 caracteres<br>Incluir al menos una mayúscula<br>Incluir all menos una minúscula<br>Incluir un carácter especial<br>Evitar el nombre del usuario<br>Evitar una contraseña ya utilizada<br>', comment: 'Password validation requirements' },
    ...
    Purple: { id: 'Purple', value: 'Morado', comment: 'Refers to an purple color band' },
    ...
    Red: { id: 'Red', value: 'Rojo', comment: 'This corresponds to a red color' },
    ...
    SetTime: { id: 'SetTime', value: 'Establecer hora', comment: 'Button that sets time in a field' },
    ...
    Small: { id: 'Small', value: 'Pequeña', comment: 'A more small grid setting for rows and sizes.' },
    ...
    Subject: { id: 'Subject', value: 'Asunto', comment: 'The subject of an calendar event.' },
    Success: { id: 'Success', value: 'Correcto', comment: 'For a success message on screen' },
    ...
    Tabs: { id: 'Tabs', value: 'Fichas...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Arrastre y coloque aquí o haga clic en <span class=\'hyperlink\'>cargar archivos</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Arrastre y coloque aquí para cargar achivos' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Error</em>: No se puede cargar más de un número máximo de archivos ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Error</em>: Se ha excedido el máximo de archivos permitidos' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Error</em>: Se ha excedido el límite de tamaño de archivo' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Error</em>: El tipo de archivo no está permitido' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Error</em>: No se encontró URL' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Error</em>: Los encabezados de la solicitud deben tener una cadena JSON válida' },
    UploadLink: { id: 'UploadLink', value: 'cargar archivos' },
    UploadCancel: { id: 'UploadCancel', value: 'Cancelar la carga de este archivo' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Cancelar todo' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Descargar este error' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: 'Archivo {file-name} cargado, {loaded} de {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Quitar este archivo' },
    UploadStart: { id: 'UploadStart', value: 'Iniciar la carga de este archivo' },
    ...
    White: { id: 'White', value: 'Blanco', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Amarillo', comment: 'This corresponds to a yellow color' },
