...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Maximum aantal tekens van {0} overschreden', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Naar klembord kopiëren', comment: 'Copy text' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Eerder dan of tot', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extra extra klein', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Genereren met AI', comment: 'Button for Generative AI' },
