...
Soho.Locale.addCulture('tr-TR', {
  ...
  messages: {
    ...
    Russian: { id: 'Russian', value: 'Rusça', comment: 'Language name for Russian' },
    ...
    SelectAll: { id: 'SelectAll', value: 'Tümünü seç', comment: 'Describes the action of selecting all items available in a list' },
    ...
    SelectedOptions: { id: 'SelectedOptions', value: 'Seçilen seçenekler', comment: 'shown on a list of selected dropdown options (generic)' },
    Selection: { id: 'Selection', value: 'Seçim', comment: 'Text describing current selections in a field' },
    Send: { id: 'Send', value: 'Gönder', comment: 'Send tooltip' },
    SetTime: { id: 'SetTime', value: 'Saati ayarla', comment: 'Button that sets time in a field' },
    ...
    SkipToMain: { id: 'SkipToMain', value: 'Ana içeriğe atla', comment: 'Skip link in header, jumps when clicked on to main area' },
    ...
    Slovak: { id: 'Slovak', value: 'Slovakça', comment: 'Language name for Slovak (Slovakia)' },
    Slovenian: { id: 'Slovenian', value: 'Slovence', comment: 'Language name for Slovenian' },
    Small: { id: 'Small', value: 'Küçük', comment: 'A more small grid setting for rows and sizes.' },
    ...
    Spanish: { id: 'Spanish', value: 'İspanyolca', comment: 'Language name for Spanish' },
    ...
    SplitterDragHandle: { id: 'SplitterDragHandle', value: 'Ayarlamak için sürükleyin', comment: 'Drags the splitter handle' },
    StartsWith: { id: 'StartsWith', value: 'Şununla Başlar', comment: 'For condition filtering' },
    Status: { id: 'Status', value: 'Durum', comment: 'Status thats submitted fx in progress, approved' },
    ...
    Success: { id: 'Success', value: 'Başarılı', comment: 'For a success message on screen' },
    ...
    Swedish: { id: 'Swedish', value: 'İsveççe', comment: 'Language name for Swedish' },
    Tabs: { id: 'Tabs', value: 'Sekmeler...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    Tack: { id: 'Tack', value: 'Sabitle', comment: 'Pin an object' },
    Tagalog: { id: 'Tagalog', value: 'Tagalogca', comment: 'Language name for Tagalog (Philippines)' },
    ...
    Teal: { id: 'Teal', value: 'Camgöbeği', comment: 'Refers to an teal color band' },
    ...
    TextDropArea: { id: 'DropArea', value: 'Yüklenecek dosyaları sürükleyin ve bırakın', comment: 'Text for drop area for advanced fileupload' },
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Yüklemek için buraya sürükleyip bırakın veya <span class=\'hyperlink\'>dosyaları yükleyin</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Buraya sürükleyip bırakın veya {browseLink}', comment: 'Updated recently' },
    Thai: { id: 'Thai', value: 'Tayca', comment: 'Language name for Thai' },
    ...
    Turkish: { id: 'Turkish', value: 'Türkçe', comment: 'Language name for Turkish' },
    ...
    Ukrainian: { id: 'Ukrainian', value: 'Ukraynaca', comment: 'Language name for Ukrainian' },
    ...
    UnorderedList: { id: 'UnorderedList', value: 'Madde işaretli listeyi ekle/kaldır', comment: 'Insert an unordered list in the editor' },
    ...
    UpComingTimeOff: { id: 'UpComingTimeOff', value: 'Yaklaşan izin', comment: 'As in time off work' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Dosyaları yüklemek için buraya sürükleyip bırakın' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Hata</em> Maksimum dosya sayısından ({maxFiles}) fazla dosya yüklenemez' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Hata</em> Maksimum izin verilen dosya aşıldı' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Hata</em> Dosya boyut sınırı aşıldı' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Hata</em> Dosya türüne izin verilmiyor' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Hata</em> Url bulunamadı' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Hata</em> İstek Başlıkları geçerli bir JSON dizesi olmalıdır' },
    UploadLink: { id: 'UploadLink', value: 'dosyaları yükle' },
    UploadCancel: { id: 'UploadCancel', value: 'Bu dosya yüklemesini iptal et' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Tümünü iptal et' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Bu hatayı kapat' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name}, {loaded} / {size} yükledi (%{percent})', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Bu dosyayı kaldır' },
    UploadStart: { id: 'UploadStart', value: 'Bu dosyayı yüklemeye başla' },
    ...
    Vietnamese: { id: 'Vietnamese', value: 'Vietnamca', comment: 'Language name for Vietnamese' },
    ...
    Warning: { id: 'Warning', value: 'Uyarı', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Beyaz', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Sarı', comment: 'This corresponds to a yellow color' },
