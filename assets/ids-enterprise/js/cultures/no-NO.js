...
Soho.Locale.addCulture('no-NO', {
  ...
  calendars: [{
    ...
    dateFormat: {
      ...
      dateTimestamp: 'dd.MM.yyyy HH:mm',
  ...
  messages: {
    ...
    Caution: { id: 'Caution', value: 'Forsiktig', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Antall tegn på {0} overskredet', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Velg en egendefinert farge', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Klikk for å åpne fargepalett', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Kopier til utklippstavle', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Utløser for datovelger', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Tidligere enn eller til', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Ekstra ekstra liten', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    Green: { id: 'Green', value: 'Grønn', comment: 'Refers to an green color band' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Utløser for oppslag', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'desember', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Nøytral', comment: 'This corresponds to a neutral color' },
    ...
    Orange: { id: 'Orange', value: 'Oransj', comment: 'Refers to an orange color band' },
    ...
    Success: { id: 'Success', value: 'Vellykket', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Blågrønn', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Dra og slipp her eller <span class=\'hyperlink\'>last opp filer</span> for å laste opp', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Dra og slipp her for å laste opp filer' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Feil</em> Kan ikke laste opp mer enn maksimalt antall filer ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Feil</em> Maksimalt tillatt antall filer overskredet' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Feil</em> Filstørrelsesgrensen overskredet' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Feil</em> Filtypen er ikke tillatt' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Feil</em> Finner ikke URL' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Feil</em> Forespørselshoder må være en gyldig JSON-streng' },
    UploadLink: { id: 'UploadLink', value: 'last opp filer' },
    UploadCancel: { id: 'UploadCancel', value: 'Avbryt opplasting av denne filen' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Avbryt alle' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Avvis denne feilen' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} lastet opp {loaded} av {size} ({percent} %)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Fjern denne filen' },
    UploadStart: { id: 'UploadStart', value: 'Begynn å laste opp denne filen' },
    ...
    White: { id: 'White', value: 'Hvit', comment: 'Refers to an white color band' },
