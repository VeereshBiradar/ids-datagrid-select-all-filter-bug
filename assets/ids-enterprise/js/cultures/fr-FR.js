...
Soho.Locale.addCulture('fr-FR', {
  ...
  messages: {
    ...
    Black: { id: 'Black', value: 'Noir', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Citation', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Bleu', comment: 'Refers to an blue color band' },
    ...
    Caution: { id: 'Caution', value: 'Attention', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Nombre maximum de caractères {0} est dépassé.', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Choisissez une couleur personnalisée', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Cliquez pour ouvrir le sélecteur de couleurs', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Copier dans le presse-papiers', comment: 'Copy text' },
    ...
    Dark: { id: 'Dark', value: 'Foncé', comment: 'The name of one of the application theme variants.' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Déclencheur de sélecteur de date', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Cliquez pour ouvrir la liste déroulante', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    Duplicate: { id: 'Duplicate', value: 'Dupliquer', comment: 'Duplicate tooltip' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Avant ou jusqu\'à', comment: 'Earlier than or equals in icons for filtering' },
    ...
    English: { id: 'English', value: 'Anglais (Etats-Unis)', comment: 'Language name for English' },
    ...
    ErrorMaxFiles: { id: 'ErrorMaxFiles', value: 'Impossible de charger plus que le nombre maximum de fichiers ({n}).', comment: 'Error string for file-upload' },
    ...
    ExampleData: { id: 'ExampleData', value: 'Exemple données', comment: 'Translated text for an example piece of data instance' },
    ExampleLabel: { id: 'ExampleLabel', value: 'Exemple libellé', comment: 'Translated text for an example label instance' },
    ExamplePlaceholder: { id: 'ExamplePlaceholder', value: 'Exemple espace réservé', comment: 'Translated text for an example form placeholder text' },
    ExitFullView: { id: 'ExitFullView', value: 'Quitter Plein affichage', comment: 'Exit full view tooltip' },
    Expand: { id: 'Expand', value: 'Développer', comment: 'Expand open a tree/submenu' },
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Développer le bac des applications', comment: 'Expand app tray tooltip' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Très très petite', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GB: { id: 'GB', value: 'Go', comment: 'Gigabyte abbreviation' },
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Générer avec IA', comment: 'Button for Generative AI' },
    ...
    Green: { id: 'Green', value: 'Vert', comment: 'Refers to an green color band' },
    ...
    Highlight: { id: 'Highlight', value: 'Surligner', comment: 'Used to highlight (select) a chart item' },
    ...
    KB: { id: 'KB', value: 'Ko', comment: 'Kilobyte abbreviation' },
    ...
    LaterOrOn: { id: 'LaterOrOn', value: 'Après ou le', comment: 'Later Than Or Equals in icons for filtering' },
    ...
    Locale: { id: 'Locale', value: 'Paramètres régionaux', comment: 'A place or locality for example en-US, it-It' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Déclencheur de recherche', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MB: { id: 'MB', value: 'Mo', comment: 'Megabyte abbreviation' },
    ...
    MenuGroup: { id: 'MenuGroup', value: 'Groupe de menus contenant le(s) élément(s) {0}', comment: 'Describes the number of menu items contained inside the group (accessibility when items are focused)' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'avril', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'août', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'décembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'janvier', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'juillet', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'juin', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'mars', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'octobre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'septembre', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Neutre', comment: 'This corresponds to a neutral color' },
    ...
    Orange: { id: 'Orange', value: 'Orange', comment: 'Refers to an orange color band' },
    ...
    PressDown: { id: 'PressDown', value: 'Utilisez la flèche vers le bas pour sélectionner', comment: 'The audible label for Tooltip about how to operate a picker' },
    ...
    Purple: { id: 'Purple', value: 'Pourpre', comment: 'Refers to an purple color band' },
    ...
    Red: { id: 'Red', value: 'Rouge', comment: 'This corresponds to a red color' },
    ...
    ResultOf: { id: 'ResultOf', value: '{0} résultat(s) sur {1}', comment: 'Text Showing current and total number of result' },
    ...
    Short: { id: 'Short', value: 'Petite', comment: 'Describes a shorted row height in a grid/list' },
    ...
    Success: { id: 'Success', value: 'Opération réussie', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Bleu sarcelle', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Glisser-déposer ici ou <span class=\'hyperlink\'>Charger les fichiers</span> pour les charger', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Glisser-déposer ici ou {browseLink}', comment: 'Updated recently' },
    Thai: { id: 'Thai', value: 'thaï', comment: 'Language name for Thai' },
    Theme: { id: 'Theme', value: 'Thème', comment: 'Refers to an application theme' },
    ThousandsAbbrev: { id: 'ThousandsAbbrev', value: '{0}milliers', comment: 'Refers to a value in a chart in thousands. i.e. 1K, 100K' },
    ...
    ToggleBold: { id: 'ToggleBold', value: 'Basculer avec l\'option de texte en gras', comment: 'turn on and off bold in text editor (like word) please check this for thai see https://github.com/infor-design/enterprise/issues/4738' },
    ...
    ToggleUnderline: { id: 'ToggleUnderline', value: 'Basculer avec l\'option de texte souligné', comment: 'turn on and off Underline in text editor (like word) please check this for thai https://github.com/infor-design/enterprise/issues/4738' },
    ...
    Turkish: { id: 'Turkish', value: 'turque', comment: 'Language name for Turkish' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Glisser-déposer ici pour charger des fichiers' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Erreur</em> Impossible de charger plus que le nombre maximum de fichiers ({maxFiles}).' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Erreur</em> Dépassement du nombre maximum de fichiers autorisés' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Erreur</em> Taille limite de fichier dépassée' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Erreur</em> Type de fichier non autorisé' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Erreur</em> Url non trouvée' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Erreur</em> En-têtes de demande doivent être une chaîne JSON valide' },
    UploadLink: { id: 'UploadLink', value: 'charger des fichiers' },
    UploadCancel: { id: 'UploadCancel', value: 'Annuler le chargement de ce fichier' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Annuler tout' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Rejeter cette erreur' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} a chargé {loaded} sur {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Supprimer ce fichier' },
    UploadStart: { id: 'UploadStart', value: 'Démarrer le chargement de ce fichier' },
    ...
    Warning: { id: 'Warning', value: 'Avertissement', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Blanc', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Jaune', comment: 'This corresponds to a yellow color' },
