...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    Caution: { id: 'Caution', value: 'Perhatian', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Melebihi jumlah karakter {0}', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Pilih warna kustom', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Pemicu pemilih tanggal', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Lebih cepat dari Atau hingga', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Ekstra Ekstra kecil', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Buat dengan AI', comment: 'Button for Generative AI' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Pemicu pencarian', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'agustus', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'maret', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Netral', comment: 'This corresponds to a neutral color' },
    ...
    Orange: { id: 'Orange', value: 'Oranye', comment: 'Refers to an orange color band' },
    ...
    Success: { id: 'Success', value: 'Berhasil', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Biru Kehijauan', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Seret dan jatuhkan di sini atau <span class=\'hyperlink\'>unggah file</span> untuk mengunggah', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Seret dan jatuhkan di sini untuk mengunggah file' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Kesalahan</em> Tidak dapat mengunggah lebih dari jumlah file maksimum ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Kesalahan</em> Melebihi batas maksimum file yang diizinkan' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Kesalahan</em> Melebihi batas ukuran file' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Kesalahan</em> Tipe file tidak diperbolehkan' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Kesalahan</em> Url tidak ditemukan' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Kesalahan</em> Permintaan Header harus string JSON yang valid' },
    UploadLink: { id: 'UploadLink', value: 'unggah file' },
    UploadCancel: { id: 'UploadCancel', value: 'Batalkan mengunggah file ini' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Batalkan semua' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Tutup kesalahan ini' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} diunggah {loaded} dari {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Hapus file ini' },
    UploadStart: { id: 'UploadStart', value: 'Mulai mengunggah file ini' },
    ...
    Warning: { id: 'Warning', value: 'Peringatan', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Putih', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Kuning', comment: 'This corresponds to a yellow color' },
