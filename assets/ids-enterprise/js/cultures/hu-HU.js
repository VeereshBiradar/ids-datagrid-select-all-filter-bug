...
Soho.Locale.addCulture('hu-HU', {
  ...
  messages: {
    ...
    AddComments: { id: 'AddComments', value: 'Megjegyzések hozzáadása', comment: 'Add comments to a form of data' },
    AddNewTab: { id: 'AddNewTab', value: 'Új lap hozzáadása', comment: 'Attached to a button that adds new tabs' },
    AdministrativeLeave: { id: 'AdministrativeLeave', value: 'Közigazgatási szabadság', comment: 'As in vacation time from work' },
    AdvancedFilter: { id: 'AdvancedFilter', value: 'Speciális szűrő létrehozása', comment: 'In a data grid active an advanced filtering feature' },
    Afrikaans: { id: 'Afrikaans', value: 'afrikaans', comment: 'Language name for Afrikaans (South Africa)' },
    Alabaster: { id: 'Alabaster', value: 'Alabástrom', comment: 'Color in our color palette' },
    ...
    AllDay: { id: 'AllDay', value: 'Egész nap', comment: 'Label for an event which lasts all day' },
    ...
    And: { id: 'And', value: 'és', comment: 'Text used in calendar' },
    ...
    Black: { id: 'Black', value: 'Fekete', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Idézetblokk', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Kék', comment: 'Refers to an blue color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Böngésző nyelve', comment: 'Language in the current web bowser' },
    ...
    Caution: { id: 'Caution', value: 'Vigyázat', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Túllépték a maximális {0} karakterszámot', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Válasszon egyéni színt', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Kattintson ide a színpaletta megnyitásához', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Másolás a vágólapra', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Dátumválasztó kiváltója', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    DiscretionaryTimeOff: { id: 'DiscretionaryTimeOff', value: 'Rendkívüli szabadság', comment: 'As in work time off' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Korábbi, mint vagy eddig', comment: 'Earlier than or equals in icons for filtering' },
    ...
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Kiválasztott vagy nem kiválasztott', comment: 'Either selected or not selected in icons for filtering' },
    ...
    EndsWith: { id: 'EndsWith', value: 'Záró karakter', comment: 'for condition filtering' },
    English: { id: 'English', value: 'Angol (Egyesült Államok)', comment: 'Language name for English' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Alkalmazástálca kibontása', comment: 'Expand app tray tooltip' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extra kicsi', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'AI által generált', comment: 'Button for Generative AI' },
    ...
    GreaterOrEquals: { id: 'GreaterOrEquals', value: 'Nagyobb vagy egyenlő, mint', comment: 'Greater Than Or Equals in icons for filtering' },
    GreaterThan: { id: 'GreaterThan', value: 'Nagyobb mint', comment: 'Greater Than in icons for filtering' },
    Green: { id: 'Green', value: 'Zöld', comment: 'Refers to an green color band' },
    ...
    InsertHyperlink: { id: 'InsertHyperlink', value: 'Hiperhivatkozás beszúrása', comment: 'Insert a hyperlink (synonymous with link or anchor tag) into an editor. Please recheck this as it was renamed from anchor.' },
    ...
    InvalidTime: { id: 'InvalidTime', value: 'Érvénytelen idő', comment: 'validation message for wrong time format' },
    ...
    LaterOrOn: { id: 'LaterOrOn', value: 'Későbbi, mint vagy ekkor', comment: 'Later Than Or Equals in icons for filtering' },
    ...
    LessOrEquals: { id: 'LessOrEquals', value: 'Kisebb vagy egyenlő, mint', comment: 'Less than or equals in icons for filtering' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Keresés kiváltója', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'április', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'augusztus', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'július', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'június', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'március', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'május', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'szeptember', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Semleges', comment: 'This corresponds to a neutral color' },
    ...
    Next: { id: 'Next', value: 'Következő', comment: 'Generic next for a tooltip, see Next Record and Next Page for more specific' },
    NextMonth: { id: 'NextMonth', value: 'Következő hónap', comment: 'The label for the button that moves calendar to next/prev' },
    NextPage: { id: 'NextPage', value: 'Következő oldal', comment: 'Move to next item on Pager component' },
    NextRecord: { id: 'NextRecord', value: 'Következő rekord', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Nincs találat', comment: 'Search Results Text' },
    NoRecordSelected: { id: 'NoRecordSelected', value: '0 rekord kiválasztva', comment: 'Text showing no records selected' },
    ...
    NotSelected: { id: 'NotSelected', value: 'Nincs kiválasztva', comment: 'Not selected in icons for filtering' },
    ...
    Orange: { id: 'Orange', value: 'Narancssárga', comment: 'Refers to an orange color band' },
    OrderedList: { id: 'OrderedList', value: 'Számozott lista beszúrása/eltávolítása', comment: 'Insert an ordered list in the editor' },
    ...
    PressDown: { id: 'PressDown', value: 'A kiválasztáshoz nyomja meg a lefelé nyíl gombot', comment: 'The audible label for Tooltip about how to operate a picker' },
    ...
    Previous: { id: 'Previous', value: 'Előző', comment: 'Generic previous for a tooltip, see next record and next page for more specific' },
    PreviousMonth: { id: 'PreviousMonth', value: 'Előző hónap', comment: 'the label for the button that moves calendar to next/prev' },
    PreviousPage: { id: 'PreviousPage', value: 'Előző oldal', comment: 'Move to next item on Pager component' },
    PreviousRecord: { id: 'PreviousRecord', value: 'Előző rekord', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    ...
    Purple: { id: 'Purple', value: 'Bíborszínű', comment: 'Refers to an purple color band' },
    ...
    RecordSelected: { id: 'RecordSelected', value: '{0} rekord kiválasztva', comment: 'Text showing current total of record selected' },
    RecordsSelected: { id: 'RecordsSelected', value: '{0} rekord kiválasztva', comment: 'Text showing current total of records selected' },
    Red: { id: 'Red', value: 'Piros', comment: 'This corresponds to a red color' },
    ...
    SavedViews: { id: 'SavedViews', value: 'Mentett nézetek', comment: 'Label for a list of Views' },
    ...
    SearchList: { id: 'SearchList', value: 'Keresés a listában', comment: 'Search list tooltip' },
    ...
    SelectAll: { id: 'SelectAll', value: 'Összes kiválasztása', comment: 'Describes the action of selecting all items available in a list' },
    ...
    SetTime: { id: 'SetTime', value: 'Idő beállítása', comment: 'Button that sets time in a field' },
    ...
    SortDown: { id: 'SortDown', value: 'Csökkenő sorrend', comment: 'Sort Down tooltip' },
    ...
    StartsWith: { id: 'StartsWith', value: 'Kezdő karakter', comment: 'For condition filtering' },
    Status: { id: 'Status', value: 'Állapot', comment: 'Status thats submitted fx in progress, approved' },
    StepsCompleted: { id: 'StepsCompleted', value: '{0}/{1}. lépés befejezve', comment: 'steps of a wizard/chart' },
    ...
    Success: { id: 'Success', value: 'Sikeres művelet', comment: 'For a success message on screen' },
    ...
    Tabs: { id: 'Tabs', value: 'tabulátor...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    ...
    Teal: { id: 'Teal', value: 'Sötét zöldeskék', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'A feltöltéshez húzza ide a fájlokat, vagy használja a <span class=\'hyperlink\'> fájlok feltöltése</span> lehetőséget', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Húzza ide a fájlokat vagy {browseLink}', comment: 'Updated recently' },
    ...
    UpliftDarkTheme: { id: 'UpliftDarkTheme', value: 'Színes sötét', comment: 'The name of an application Theme' },
    UpliftHighContrastTheme: { id: 'UpliftHighContrastTheme', value: 'Színes kontrasztos', comment: 'The name of an application Theme' },
    UpliftLightTheme: { id: 'UpliftLightTheme', value: 'Színes világos', comment: 'The name of an application Theme' },
    Upload: { id: 'Upload', value: 'Feltöltés', comment: 'Upload tooltip' },
    UploadDropArea: { id: 'UploadDropArea', value: 'Húzza ide a fájlokat a feltöltéshez' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Hiba</em> Nem tölthető fel a maximálisan megengedettnél több fájl ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Hiba</em> Túllépte a fájlok megengedett maximális számát' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Hiba</em> Túllépte a maximális fájlméretet' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Hiba</em> A fájltípus használata nem megengedett' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Hiba</em> Nincsenek találatok' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Hiba</em> A Kérelemfejlécek elemnek érvényes JSON-sztringnek kell lennie' },
    UploadLink: { id: 'UploadLink', value: 'fájlok feltöltése' },
    UploadCancel: { id: 'UploadCancel', value: 'Fájl feltöltésének megszakítása' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Összes megszakítása' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Hibaüzenet bezárása' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} feltöltve {loaded}/{size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Fájl eltávolítása' },
    UploadStart: { id: 'UploadStart', value: 'Fájl feltöltésének megkezdése' },
    ...
    Warning: { id: 'Warning', value: 'Figyelmeztetés', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Fehér', comment: 'Refers to an white color band' },
    Week: { id: 'Week', value: 'Hét', comment: 'Shows a view of the current weeks events' },
    WeekNumber: { id: 'WeekNumber', value: 'H#', comment: 'Week view number header on the datepicker' },
    Year: { id: 'Year', value: 'Év', comment: 'As in a date year' },
    Yellow: { id: 'Yellow', value: 'Sárga', comment: 'This corresponds to a yellow color' },
