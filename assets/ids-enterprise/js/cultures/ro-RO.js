...
Soho.Locale.addCulture('ro-RO', {
  ...
  messages: {
    ...
    SetTime: { id: 'SetTime', value: 'Setare oră', comment: 'Button that sets time in a field' },
    ...
    SickTime: { id: 'SickTime', value: 'Concediu medical', comment: 'Time off sick from work' },
    ...
    Small: { id: 'Small', value: 'Mic', comment: 'A more small grid setting for rows and sizes.' },
    ...
    Status: { id: 'Status', value: 'Stare', comment: 'Status thats submitted fx in progress, approved' },
    ...
    Success: { id: 'Success', value: 'Succes', comment: 'For a success message on screen' },
    ...
    Tabs: { id: 'Tabs', value: 'File...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    ...
    Teal: { id: 'Teal', value: 'Turcoaz', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Pentru a le încărca, glisați și fixați aici sau <span class=\'hyperlink\'>încărcați fișierele</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Glisați și fixați aici sau {browseLink}', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Glisați și fixați aici pentru a încărca fișierele' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Eroare</em> Nu se poate încărca mai mult decât numărul maxim de fișiere ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Eroare</em> A fost depășită limita maximă permisă pentru fișiere' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Eroare</em> A fost depășită limita pentru dimensiunea fișierului' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Eroare</em> Tipul de fișier nu este permis' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Eroare</em> URL-ul nu a fost găsit' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Eroare</em> Antetele solicitării trebuie să fie stringuri JSON valide' },
    UploadLink: { id: 'UploadLink', value: 'încărcare fișiere' },
    UploadCancel: { id: 'UploadCancel', value: 'Anularea încărcării acestui fișier' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Revocare totală' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Respingere eroare' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} a încărcat {loaded} din {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Eliminarea acestui fișier' },
    UploadStart: { id: 'UploadStart', value: 'Începerea încărcării acestui fișier' },
    ...
    Warning: { id: 'Warning', value: 'Avertisment', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Alb', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Galben', comment: 'This corresponds to a yellow color' },
