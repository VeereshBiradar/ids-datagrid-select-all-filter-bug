...
Soho.Locale.addCulture('en-US', {
  ...
  messages: {
    ...
    DeselectAll: { id: 'DeselectAll', value: 'Deselect all', comment: 'Describes the action of deselecting all items in a list' },
    DeselectAllRows: { id: 'DeselectAllRows', value: 'Deselect all rows', comment: 'Used in accessible labels to describe the action of deselecting all rows in a grid' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Earlier than Or until', comment: 'Earlier than or equals in icons for filtering' },
    ...
    GB: { id: 'GB', value: 'GB', comment: 'Gigabyte abbreviation' },
    ...
    KB: { id: 'KB', value: 'KB', comment: 'Kilobyte abbreviation' },
    ...
    MB: { id: 'MB', value: 'MB', comment: 'Megabyte abbreviation' },
    ...
    SelectAllRows: { id: 'SelectAllRows', value: 'Select all rows', comment: 'Describes the action of selecting all rows available in a grid' },
    ...
    DirtyIndicator: { id: 'DirtyIndicator', value: 'Attention: {0} was modified', comment: 'Dirty indicator message' }
  }
});
