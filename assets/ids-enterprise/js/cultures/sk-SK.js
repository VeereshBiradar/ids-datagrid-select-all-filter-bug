...
Soho.Locale.addCulture('sk-SK', {
  ...
  messages: {
    ...
    Success: { id: 'Success', value: 'Úspech', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Modrozelená', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Presuňte sem alebo <span class=\'hyperlink\'>nahrajte súbory</span> určené na nahratie', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Presuňte sem alebo nahrajte súbory' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Nie je možné nahrať viac ako maximálny počet súborov ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Chyba</em> Bol presiahnutý limit povoleného počtu súborov' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Chyba</em> Bol presiahnutý limit veľkosti súboru' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Chyba</em> Typ súboru nie je povolený' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Adresa URL sa nenašla' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Chyba</em> Hlavičky požiadavky musia predstavovať platný reťazec JSON' },
    UploadLink: { id: 'UploadLink', value: 'nahrať súbory' },
    UploadCancel: { id: 'UploadCancel', value: 'Zrušiť nahrávanie tohto súboru' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Zrušiť všetko' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Zavrieť túto chybu' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} nahraté {loaded} z {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Odstrániť tento súbor' },
    UploadStart: { id: 'UploadStart', value: 'Začať s nahrávaním tohto súboru' },
    ...
    Warning: { id: 'Warning', value: 'Varovanie', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Biela', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Žltá', comment: 'This corresponds to a yellow color' },
