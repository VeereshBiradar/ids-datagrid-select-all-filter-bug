...
Soho.Locale.addCulture('sv-SE', {
  ...
  messages: {
    ...
    And: { id: 'And', value: 'och', comment: 'Text used in calendar' },
    ...
    Black: { id: 'Black', value: 'Svart', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Blockcitat', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Blått', comment: 'Refers to an blue color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Webbläsarspråk', comment: 'Language in the current web bowser' },
    ...
    Caution: { id: 'Caution', value: 'Varning', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Max antal tecken {0} har överskridits', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Välj en anpassad färg', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Öppna färgväljaren genom att klicka', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Kopiera till Urklipp', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Trigger för datumväljare', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Tidigare än eller till och med', comment: 'Earlier than or equals in icons for filtering' },
    ...
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Har antingen markerats eller inte markerats', comment: 'Either selected or not selected in icons for filtering' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Expandera programfält', comment: 'Expand app tray tooltip' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extra extra liten', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    FileUpload: { id: 'FileUpload', value: 'Filöverföring. Tryck på Retur när du vill bläddra efter en fil', comment: 'Screen Reader instructions' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Generera med AI', comment: 'Button for Generative AI' },
    ...
    Green: { id: 'Green', value: 'Grönt', comment: 'Refers to an green color band' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Trigger för sökfält', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseAug: { id: 'MonthWideAug', value: 'augusti', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Neutral: { id: 'Neutral', value: 'Neutralt', comment: 'This corresponds to a neutral color' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Inga resultat', comment: 'Search Results Text' },
    ...
    Purple: { id: 'Purple', value: 'Lila', comment: 'Refers to an purple color band' },
    ...
    Red: { id: 'Red', value: 'Rött', comment: 'This corresponds to a red color' },
    ...
    SetTime: { id: 'SetTime', value: 'Ange tid', comment: 'Button that sets time in a field' },
    ...
    Success: { id: 'Success', value: 'Lyckades', comment: 'For a success message on screen' },
    ...
    Tabs: { id: 'Tabs', value: 'Flikar ...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    ...
    Teal: { id: 'Teal', value: 'Turkos', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Överför genom att dra och släppa här eller <span class=\'hyperlink\'>överför filer</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Dra och släpp här eller {browseLink}', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Överför filer genom att dra och släppa dem här' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Fel</em> Det går inte att överföra fler än det maximala antalet filer ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Fel</em> Tillåtet antal filer har överskridits' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Fel</em> Tillåten filstorlek har överskridits' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Fel</em> Filtypen tillåts inte' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Fel</em> URL:en hittades inte' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Fel</em> Sidhuvud i förfrågningar måste vara en giltig JSON-sträng' },
    UploadLink: { id: 'UploadLink', value: 'överför filer' },
    UploadCancel: { id: 'UploadCancel', value: 'Avbryt överföring av denna fil' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Avbryt alla' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Ignorera detta fel' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name}: {loaded} av {size} ({percent}%) har överförts', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Ta bort denna fil' },
    UploadStart: { id: 'UploadStart', value: 'Starta överföring av denna fil' },
    ...
    Warning: { id: 'Warning', value: 'Varning', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Vitt', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Gult', comment: 'This corresponds to a yellow color' },
