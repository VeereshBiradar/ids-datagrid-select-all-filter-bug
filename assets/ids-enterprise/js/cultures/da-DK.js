...
Soho.Locale.addCulture('da-DK', {
  ...
  messages: {
    ...
    Black: { id: 'Black', value: 'Sort', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Bloktilbud', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Blå', comment: 'Refers to an blue color band' },
    ...
    Caution: { id: 'Caution', value: 'Forsigtig', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Overskred antallet af tegn, som er {0}', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Vælg en brugerdefineret farve', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Klik for at åbne farvevælgeren', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Kopiér til udklipsholder', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Udløser for datovælger', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Tidligere end eller indtil', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Ekstra ekstra lille', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Generer med AI', comment: 'Button for Generative AI' },
    ...
    Green: { id: 'Green', value: 'Grøn', comment: 'Refers to an green color band' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Udløser for opslag', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    Red: { id: 'Red', value: 'Rød', comment: 'This corresponds to a red color' },
    ...
    Success: { id: 'Success', value: 'Gennemført', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Blågrøn', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Træk og slip filerne her, eller <span class=\'hyperlink\'>overfør filerne</span>', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Træk og slip her for at overføre filer' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Fejl</em> Der kan ikke overføres mere end det maksimale antal filer ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Fejl</em> Tilladt grænse for højeste antal tilladte filer er overskredet' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Fejl</em> Grænse for filstørrelse er overskredet' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Fejl</em> Filtypen er ikke tilladt' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Fejl</em> URL-adressen blev ikke fundet' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Fejl</em> De sidehoveder, der anmodes om, skal være en gyldig JSON-streng' },
    UploadLink: { id: 'UploadLink', value: 'overfør filer' },
    UploadCancel: { id: 'UploadCancel', value: 'Annuller overførsel af denne fil' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Annuller alle' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Afvis denne fejl' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} overført {loaded} ud af {size} ({percent} %)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Fjern denne fil' },
    UploadStart: { id: 'UploadStart', value: 'Start overførsel af denne fil' },
    ...
    Warning: { id: 'Warning', value: 'Advarsel', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Hvid', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Gul', comment: 'This corresponds to a yellow color' },
