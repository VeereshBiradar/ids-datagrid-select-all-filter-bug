...
Soho.Locale.addCulture('pt-PT', {
  ...
  messages: {
    ...
    Black: { id: 'Black', value: 'Preto', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Trecho em bloco', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Azul', comment: 'Refers to an blue color band' },
    ...
    BrowserLanguage: { id: 'BrowserLanguage', value: 'Idioma do navegador', comment: 'Language in the current web bowser' },
    ...
    Caution: { id: 'Caution', value: 'Cuidado', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Contagem de caracteres de {0} excedida', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Selecionar uma cor personalizada', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Clicar para abrir o seletor de cores', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'Copiar para a área de transferência', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Acionador do seletor de data', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    DropdownTriggerButton: { id: 'DropdownTriggerButton', value: 'Clicar para abrir a lista pendente', comment: 'Used in accessible labels to describe a dropdown\'s trigger button to assistive technology' },
    ...
    EarlyOrEquals: { id: 'EarlyOrEquals', value: 'Anteriores ou iguais a', comment: 'Earlier than or equals in icons for filtering' },
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Anterior ou até', comment: 'Earlier than or equals in icons for filtering' },
    ...
    EitherSelectedOrNotSelected: { id: 'EitherSelectedOrNotSelected', value: 'Selecionado ou não selecionado', comment: 'Either selected or not selected in icons for filtering' },
    ...
    English: { id: 'English', value: 'Inglês (EUA)', comment: 'Language name for English' },
    ...
    ExpandAppTray: { id: 'ExpandAppTray', value: 'Expandir tabuleiro de aplicações', comment: 'Expand app tray tooltip' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extra extra pequeno', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Gerar com IA', comment: 'Button for Generative AI' },
    ...
    GreaterThan: { id: 'GreaterThan', value: 'Maior do que', comment: 'Greater Than in icons for filtering' },
    ...
    LaterOrEquals: { id: 'LaterOrEquals', value: 'Posteriores ou iguais a', comment: 'Later than or equals in icons for filtering' },
    LaterOrOn: { id: 'LaterOrOn', value: 'Posterior ou em', comment: 'Later Than Or Equals in icons for filtering' },
    ...
    LessThan: { id: 'LessThan', value: 'Menor do que', comment: 'Less than in icons for filtering' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Acionador de procura', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MenuGroup: { id: 'MenuGroup', value: 'Grupo de menus com {0} item(s)', comment: 'Describes the number of menu items contained inside the group (accessibility when items are focused)' },
    ...
    MonthWideLowerCaseApr: { id: 'MonthWideApr', value: 'abril', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'dezembro', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseJan: { id: 'MonthWideJan', value: 'janeiro', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJuly: { id: 'MonthWideJuly', value: 'julho', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseJune: { id: 'MonthWideJune', value: 'junho', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'março', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseMay: { id: 'MonthWideMay', value: 'maio', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseNov: { id: 'MonthWideNov', value: 'novembro', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseOct: { id: 'MonthWideOct', value: 'outubro', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    MonthWideLowerCaseSep: { id: 'MonthWideSep', value: 'setembro', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Next: { id: 'Next', value: 'Seguinte', comment: 'Generic next for a tooltip, see Next Record and Next Page for more specific' },
    NextMonth: { id: 'NextMonth', value: 'Mês seguinte', comment: 'The label for the button that moves calendar to next/prev' },
    NextPage: { id: 'NextPage', value: 'Página seguinte', comment: 'Move to next item on Pager component' },
    NextRecord: { id: 'NextRecord', value: 'Registo seguinte', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    NextWeek: { id: 'NextWeek', value: 'Semana seguinte', comment: 'The label for the button that moves calendar to next/prev' },
    ...
    NoData: { id: 'NoData', value: 'Nenhuns dados disponíveis', comment: 'Shown when there is no rows shown in a list' },
    ...
    NoResultsFound: { id: 'NoResultsFound', value: 'Nenhum resultado encontrado', comment: 'Search Results Text' },
    NoRecordSelected: { id: 'NoRecordSelected', value: '0 registos selecionados', comment: 'Text showing no records selected' },
    ...
    Orange: { id: 'Orange', value: 'Laranja', comment: 'Refers to an orange color band' },
    ...
    PasswordValidation: { id: 'PasswordValidation', value: '<strong>A palavra-passe</strong><br>Tem de ter, pelo menos, 10 caracteres<br>Ter, pelo menos, um carácter maiúsculo<br>Ter, pelo menos, um carácter minúsculo<br>Ter um carácter especial<br>Não pode ter o seu nome de utilizador<br>Não pode ser uma palavra-passe utilizada anteriormente<br>', comment: 'Password validation requirements' },
    ...
    PreviousRecord: { id: 'PreviousRecord', value: 'Registo anterior', comment: 'Can be used as a tooltip for arrow navigation on a form moving between records' },
    ...
    Purple: { id: 'Purple', value: 'Roxo', comment: 'Refers to an purple color band' },
    ...
    RecordSelected: { id: 'RecordSelected', value: '{0} registos selecionados', comment: 'Text showing current total of record selected' },
    RecordsSelected: { id: 'RecordsSelected', value: '{0} registos selecionados', comment: 'Text showing current total of records selected' },
    Red: { id: 'Red', value: 'Vermelho', comment: 'This corresponds to a red color' },
    ...
    SetTime: { id: 'SetTime', value: 'Definir hora', comment: 'Button that sets time in a field' },
    ...
    Status: { id: 'Status', value: 'Estado', comment: 'Status thats submitted fx in progress, approved' },
    ...
    Success: { id: 'Success', value: 'Êxito', comment: 'For a success message on screen' },
    ...
    Tabs: { id: 'Tabs', value: 'Separadores...', comment: 'Used in the tabs component more menu, preceeded by a number that describes how many tabs are in the spillover menu' },
    ...
    Teal: { id: 'Teal', value: 'Verde-azulado', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Arrastar e largar ficheiros aqui ou <span class=\'hyperlink\'>carregar ficheiros</span> para carregar', comment: 'Note please recheck, dont translate the <span> markup please' },
    TextDropAreaWithBrowseLink: { id: 'TextDropAreaWithBrowse', value: 'Arrastar e largar aqui ou {browseLink}', comment: 'Updated recently' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Arrastar e largar aqui para carregar ficheiros' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Erro</em> Não é possível atualizar mais do que o número máximo de ficheiros ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Erro</em> Limite máximo de ficheiros permitidos excedido' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Erro</em> Limite do tamanho de ficheiro excedido' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Erro</em> Tipo de ficheiro não permitido' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Erro</em> URL não encontrado' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Erro</em> Solicitar cabeçalhos tem de ser uma cadeia JSON válida' },
    UploadLink: { id: 'UploadLink', value: 'carregar ficheiros' },
    UploadCancel: { id: 'UploadCancel', value: 'Cancelar o carregamento deste ficheiro' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Cancelar tudo' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Dispensar este erro' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} carregado {loaded} de {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Remover este ficheiro' },
    UploadStart: { id: 'UploadStart', value: 'Iniciar o carregamento deste ficheiro' },
    ...
    Warning: { id: 'Warning', value: 'Aviso', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Branco', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Amarelo', comment: 'This corresponds to a yellow color' },
