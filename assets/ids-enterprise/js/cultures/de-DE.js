...
Soho.Locale.addCulture('de-DE', {
  ...
  messages: {
    ...
    Black: { id: 'Black', value: 'Schwarz', comment: 'Refers to an black color band' },
    Blockquote: { id: 'Blockquote', value: 'Blockzitat', comment: 'Term for Block Quotations in editing' },
    Blue: { id: 'Blue', value: 'Blau', comment: 'Refers to an blue color band' },
    ...
    Caution: { id: 'Caution', value: 'Achtung!', comment: 'As in a caution message on screen' },
    ...
    CharactersMax: { id: 'CharactersMax', value: 'Maximale Anzahl von {0} Zeichen überschritten', comment: 'indicator showing how many max characters you can type UPDATED' },
    ...
    ColorPickerSelection: { id: 'ColorPickerSelection', value: 'Benutzerdefinierte Farbe auswählen', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ColorPickerTriggerButton: { id: 'ColorPickerTriggerButton', value: 'Zum Öffnen des Farbwählers anklicken', comment: 'Used in accessible labels to describe a color picker fields trigger button to assistive technology' },
    ...
    CopyToClipboard: { id: 'CopyToClipboard', value: 'In Zwischenablage kopieren', comment: 'Copy text' },
    ...
    DatePickerTriggerButton: { id: 'DatePickerTriggerButton', value: 'Auslöser für Datumsauswahl', comment: 'Used in accessible labels to describe a date picker fields trigger button to assistive technology' },
    ...
    EarlierOrUntil: { id: 'EarlierOrUntil', value: 'Früher als oder bis', comment: 'Earlier than or equals in icons for filtering' },
    ...
    ExtraExtraSmall: { id: 'ExtraExtraSmall', value: 'Extrem klein', comment: 'An even smaller font size and compressed mode for datagrid rows.' },
    ...
    GenerateWithAI: { id: 'GenerateWithAI', value: 'Mit KI generieren', comment: 'Button for Generative AI' },
    ...
    Green: { id: 'Green', value: 'Grün', comment: 'Refers to an green color band' },
    ...
    LookupTriggerButton: { id: 'LookupTriggerButton', value: 'Auslöser für Abfrage', comment: 'Used in accessible labels to describe a lookup fields trigger button to assistive technology' },
    ...
    MonthWideLowerCaseDec: { id: 'MonthWideDec', value: 'Dezember', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    MonthWideLowerCaseMar: { id: 'MonthWideMar', value: 'März', comment: 'Month in lower case form,in some languages/situations this must be lower case (but not english)' },
    ...
    Purple: { id: 'Purple', value: 'Violett', comment: 'Refers to an purple color band' },
    ...
    Red: { id: 'Red', value: 'Rot', comment: 'This corresponds to a red color' },
    ...
    Success: { id: 'Success', value: 'Erfolgreich ausgeführt', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Blaugrün', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Dateien mit Drag & Drop hier ablegen oder zum Hochladen auf <span class=\'hyperlink\'>Dateien hochladen</span> klicken', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Dateien mit Drag & Drop zum Hochladen auswählen' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Fehler</em> Es können nur maximal {maxFiles} Dateien hochgeladen werden' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Fehler</em> Maximal zulässige Dateianzahl überschritten' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Fehler</em> Maximalwert für Dateigröße überschritten' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Fehler</em> Dateityp ist nicht zulässig' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Fehler</em> URL ist nicht vorhanden' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Fehler</em> Anforderungsköpfe müssen eine gültige JSON-Zeichenfolge sein' },
    UploadLink: { id: 'UploadLink', value: 'Dateien hochladen' },
    UploadCancel: { id: 'UploadCancel', value: 'Upload für diese Datei abbrechen' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Alle abbrechen' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Diesen Fehler schließen' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} hochgeladen {loaded} von {size} ({percent} %)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Diese Datei entfernen' },
    UploadStart: { id: 'UploadStart', value: 'Upload für diese Datei starten' },
    ...
    Warning: { id: 'Warning', value: 'Warnung', comment: 'As in a warning message on screen' },
    White: { id: 'White', value: 'Weiß', comment: 'Refers to an white color band' },
    ...
    Yellow: { id: 'Yellow', value: 'Gelb', comment: 'This corresponds to a yellow color' },
