...
Soho.Locale.addCulture('ms-MY', {
  ...
  messages: {
    ...
    Success: { id: 'Success', value: 'Berjaya', comment: 'For a success message on screen' },
    ...
    Teal: { id: 'Teal', value: 'Teal', comment: 'Refers to an teal color band' },
    ...
    TextDropAreaWithBrowse: { id: 'TextDropAreaWithBrowse', value: 'Seret dan lepas di sini atau <span class=\'hyperlink\'>muat naik fail</span> untuk memuat naik', comment: 'Note please recheck, dont translate the <span> markup please' },
    ...
    UploadDropArea: { id: 'UploadDropArea', value: 'Seret dan lepas di sini untuk muat naik fail' },
    UploadErrorMaxFiles: { id: 'UploadErrorMaxFiles', value: '<em>Ralat</em> Tidak boleh memuat naik lebih daripada bilangan maksimum fail ({maxFiles})' },
    UploadErrorMaxFilesInProgress: { id: 'UploadErrorMaxFiles', value: '<em>Ralat</em> Melebihi had fail maksimum yang dibenarkan' },
    UploadErrorMaxFileSize: { id: 'UploadErrorMaxFileSize', value: '<em>Ralat</em> Melebihi had saiz fail' },
    UploadErrorAcceptedFileType: { id: 'UploadErrorAcceptedFileType', value: '<em>Ralat</em> Jenis fail tidak dibenarkan' },
    UploadErrorUrl: { id: 'UploadErrorUrl', value: '<em>Ralat</em> Url tidak ditemukan' },
    UploadErrorXHRHeaders: { id: 'UploadErrorUrl', value: '<em>Ralat</em> Pengepalan Permintaan mestilah rentetan JSON yang sah' },
    UploadLink: { id: 'UploadLink', value: 'muat naik fail' },
    UploadCancel: { id: 'UploadCancel', value: 'Batal memuat naik fail ini' },
    UploadCancelAll: { id: 'UploadCancelAll', value: 'Batal semua' },
    UploadDismissError: { id: 'UploadDismissError', value: 'Tolak ralat ini' },
    UploadProgressLabel: { id: 'UploadProgressLabel', value: '{file-name} dimuat naik {loaded} daripada {size} ({percent}%)', comment: 'Contents in {} are dynamically inserted' },
    UploadRemoveFile: { id: 'UploadRemoveFile', value: 'Alih keluar fail ini' },
    UploadStart: { id: 'UploadStart', value: 'Mula memuat naik fail ini' },
    ...
    Warning: { id: 'Warning', value: 'Amaran', comment: 'As in a warning message on screen' },
